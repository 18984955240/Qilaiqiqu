...
public class UpdateManager {
	...
	private void getNewVersion() {
		new XUtilsNew().httpGet("common/queryVersion.html", false, context, new XUtilsNew.XUtilsCallBackGet() {
			...
			public void onMySuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					System.out.println("UpdateManager versionnum:"+jsonObject.getJSONObject("data").getInt("versionNum"));
					System.out.println("UpdateManager nowVersionCode:"+nowVersionCode);

					if (jsonObject.getJSONObject("data").getInt("versionNum") > nowVersionCode) {
						spec = jsonObject.getJSONObject("data").getString("versionUrl");
