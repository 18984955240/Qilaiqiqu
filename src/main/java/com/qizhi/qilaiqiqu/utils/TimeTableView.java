...
import com.qizhi.qilaiqiqu.model.TimeTableModel;
...
//            R.drawable.select_label_yi, R.drawable.select_label_wuw};
    ...
    private View getWeekTransverseLine() {
        ...
        mWeekline.setBackgroundColor(getResources().getColor(R.color.gray));
    ...
    private void initView() {
        ...
        for (int i = 0; i <= WEEKNUM; i++) {
            switch (i) {
                case 0:
                    ...
                    for (int j = 1; j <= MAXNUM; j++) {
                        ...
                        mNum.setTextColor(getResources().getColor(R.color.dark));
                ...
                case 7:
                    ...
                    mWeekName.setTextColor(getResources().getColor(R.color.dark));
            ...
            l.setWidth(2);
            l.setBackgroundColor(getResources().getColor(R.color.bule));
