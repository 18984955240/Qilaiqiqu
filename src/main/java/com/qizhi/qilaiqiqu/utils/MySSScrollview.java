...
/**
 * Created by dell1 on 2016/9/3.
 */
public class MySSScrollview extends ScrollView {
    ...
    public MySSScrollview(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }
    ...
    private Handler handler = new Handler()
    {
        ...
        {
            int scrollY = MySSScrollview.this.getScrollY();
