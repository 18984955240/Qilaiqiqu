...
public class RoundImageView  extends ImageView {
    ...
    public RoundImageView (Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取边界的颜色
        mBorderColor = a.getColor(R.styleable.CircleImageView_border_colors, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_border_overlays, DEFAULT_BORDER_OVERLAY);
