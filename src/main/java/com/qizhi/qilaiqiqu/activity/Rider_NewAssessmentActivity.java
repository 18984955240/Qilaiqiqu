 ...
 *  陪骑自我介绍
 */
public class Rider_NewAssessmentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rider__new_assessment);
        initView();
        initEvent();
    }
    private void initView(){
        ...
        flag3 = (TextView) findViewById(R.id.flag3);
        flag4 = (TextView) findViewById(R.id.flag4);
        ...
        View view1 = LayoutInflater.from(this).inflate(R.layout.assessment_tab1, null);
        View view2 = LayoutInflater.from(this).inflate(R.layout.assessment_tab2, null);
        View view3 = LayoutInflater.from(this).inflate(R.layout.assessment_tab3, null);
        View view4 = LayoutInflater.from(this).inflate(R.layout.assessment_tab4, null);
