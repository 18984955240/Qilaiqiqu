 ...
 *	路径规划
 */
public class RouteOverlayActivity extends MyBaseActivity implements
...
//                ReleaseActiveActivitySecond.lanName = ars;
//                ReleaseActiveActivitySecond.lanInfo = llp;
//                ReleaseActiveActivitySecond.mileage = (distance / 1000) + "";
    ...
    private void addAddress() {
        System.out.println("RouteOverlayActivity adress="+adress);
        list.add(adress);
