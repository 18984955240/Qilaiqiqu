...
public class ChatActivity extends MyBaseActivity {
	...
	int[] to = { R.id.chatlist_image_me,
			R.id.chatlist_text_me,
			R.id.chatlist_img_me,
			R.id.chatlist_voice_me,
			R.id.chatlist_voiceLength_me,
			R.id.chatlist_voiceCoentent_me,
			R.id.chatlist_unread_me,

			R.id.chatlist_image_other,
			R.id.chatlist_text_other,
			R.id.chatlist_img_other,
			R.id.chatlist_voice_other,
			R.id.chatlist_voiceLength_other,
			R.id.chatlist_voiceCoentent_other,
			R.id.chatlist_unread_other,
	...
	private class NewMessageBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			System.out.println("ChatActivity:Expand;"
					+ message.getStringAttribute("conversationOtherUserNameExpand", null)
					+ ","
					+ message.getStringAttribute(
							"conversationOtherUserImageExpand", null));
