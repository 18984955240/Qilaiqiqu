...
public class GuideActivity extends MyBaseActivity {
    ...
    private void initView(){
        ...
        imageView = (ImageView) findViewById(R.id.guideActivity_back);

        flag1 = (TextView) findViewById(R.id.guide_flag1);
        flag2 = (TextView) findViewById(R.id.guide_flag2);
        flag3 = (TextView) findViewById(R.id.guide_flag3);
        flag4 = (TextView) findViewById(R.id.guide_flag4);
        ...
        View view4 = LayoutInflater.from(this).inflate(R.layout.guide_tab4, null);
