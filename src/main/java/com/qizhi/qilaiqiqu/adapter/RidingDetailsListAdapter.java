...
//			zeroholder.oneImg.setBlurImageByUrl("http://img.weride.com.cn/"+list.get(position).getArticleDetailList().get(position).getArticleImage());
//			int blurFactor = BlurImageView.DEFAULT_BLUR_FACTOR;
//			zeroholder.oneImg.setBlurFactor(blurFactor+10);
			if(height == 0){
	...
	public static class ZeroViewHolder{
		private ImageView photoImg;
		private TextView title;
		public static ImageView oneImg;
//		private BlurImageView oneImg;
