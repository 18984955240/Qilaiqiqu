...
public class RidingListAdapter extends BaseAdapter{
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		case TYPE_ONE:
			...
			if(list.get(position - rDraftModels.size()).getTitle().length()>10){
				String str = list.get(position - rDraftModels.size()).getTitle().substring(0,10);
				oneholder.titleTxt.setText(str+"...");
			} else {
