...
public class Previewadapter extends BaseAdapter {
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		if(position == 0){
			...
			if(height == 0){
				oneLayout.measure(0, 0);
				height = oneLayout.getMeasuredHeight();
			}
			...
			Picasso.with(context).load("file://" +list.get(position).getArticleImage())
			.resize(800, 480)
			.centerInside()
			.placeholder(R.drawable.bitmap_homepage)
			.error(R.drawable.bitmap_homepage).into(oneImg);
