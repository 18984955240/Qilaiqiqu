...
public class ChatRecordAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(list.get(position).getChatType() == ChatType.GroupChat){
				holder.nameTxt.setText(list.get(position).getStringAttribute("IMConversationUserNameExpand"));
				...
				holder.portraitImg.setBackgroundResource(R.drawable.im_group);
			...
			SystemUtil.Imagexutils_photo(list.get(position).getStringAttribute("IMUserImageExpand"), holder.portraitImg, context);
		}
