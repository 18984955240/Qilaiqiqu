 ...
 *			陪骑
 */
public class RiderAccompanyAdapter extends BaseAdapter {
	...
	public RiderAccompanyAdapter(Context context, List<NewsRiderModel> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.list_rider_accompany, null);
		...
		if(list.get(position).getIsAgree().equals("0")){
			...
			holder.conditionTxt.setText("已拒绝");
