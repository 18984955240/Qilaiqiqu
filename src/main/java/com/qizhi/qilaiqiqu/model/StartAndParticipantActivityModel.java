...
public class StartAndParticipantActivityModel {
    ...
    private List<?> activityCommentList;
    private List<?> activityShareList;
	...
	public List<?> getActivityCommentList() {
		return activityCommentList;
	}
	public void setActivityCommentList(List<?> activityCommentList) {
		this.activityCommentList = activityCommentList;
	}
	public List<?> getActivityShareList() {
		return activityShareList;
	}
	public void setActivityShareList(List<?> activityShareList) {
