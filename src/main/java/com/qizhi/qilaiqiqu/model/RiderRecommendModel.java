...
public class RiderRecommendModel {
	...
	private String userName;
     ...
     private boolean isrecomemd;
     private boolean allowSystemRecomend;
     private boolean isSystemRecomend;
	...
	public boolean isIsrecomemd() {
		return isrecomemd;
	}
	public void setIsrecomemd(boolean isrecomemd) {
		this.isrecomemd = isrecomemd;
	}
	public boolean isAllowSystemRecomend() {
		return allowSystemRecomend;
	}
	public void setAllowSystemRecomend(boolean allowSystemRecomend) {
		this.allowSystemRecomend = allowSystemRecomend;
	}
	public boolean isSystemRecomend() {
		return isSystemRecomend;
	}
	public void setSystemRecomend(boolean isSystemRecomend) {
